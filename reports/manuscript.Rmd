...
abstract: |
  ...
  For example, educational screen use was generally associted with better learning outcomes.
  Some types of screen use have complex associations with outcomes.
  For example, television viewing showed harmful correlations with body composition and learning.
...
Additionally, most effects were small, with the association between internet use and depression the largest at $r = 0.25$ ($k = 118, N = 527,696$).
