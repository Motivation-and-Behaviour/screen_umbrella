...
There were `r n_edu_effect` unique effects associated with education outcomes, including general learning outcomes, literacy, numeracy, and science. We removed `r n_edu_noindiv` effects that did not provide individual study-level data, `r n_edu_samplesize` effects with samples < 1,000, and `r n_edu_faileggers` with a significant Egger's test or insufficient studies to conduct the test. No remaining studies showed evidence of excessive significance. Effects not meeting one or more of these standards are presented in the supplementary material. The remaining `r n_edu_certain` met our criteria for statistical credibility and are described in Figure \@ref(fig:eduplot). <!-- TODO --> These `r n_edu_certain` effects came from X meta-analytic reviews analysing data from XXX empirical studies with XXX,XXXX individual participants. 
