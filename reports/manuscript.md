...
To facilitate comparisons, we converted effect sizes to Pearson’s *r* using established formulae.<sup>27,28</sup> Effect sizes on the original metric are provided in Supplementary File 2.</span>
...
We descriptively present the remaining meta-analytic effect sizes. To remove the differences in approach to meta-analyses across the reviews, we reran the effect size estimate using a random effects meta-analysis via the metafor package<sup>29</sup> in R<sup>30</sup> (version 4.2.2) when the meta-analysis’s authors provided primary study data associated with these effects. When required, we imputed missing sample sizes using mean imputation from the other studies within that review. From our reanalysis we also extracted *I*<sup>2</sup> values. To test for publication bias, we conducted Egger’s test<sup>31</sup> when the number of studies within the review was ten or more,<sup>32</sup> and conducted a test of excess significance.<sup>33</sup> <span id="r2_32">We contacted authors who did not provide primary study data in their published article. Where authors did not provide data in a format that could be re-analysed, we used the published results of their original meta-analysis.</span>
...
The most frequently reported exposures were general screen use (*n* = 47), physically active video games (*n* = 34), general TV programs and movies (*n* = 28), and to promote health intervention (*n* = 18). Supplementary File 4 provides a list of all exposures identified. The most frequently reported outcomes were general learning (*n* = 47), body composition (*n* = 43), general physical activity (*n* = 25), depression psychological health (*n* = 19), and general literacy (*n* = 15). In 201 cases there was only one exposure/outcome combination for an age group, with 43 appearing twice, and 30 appearing three or more times. Full characteristics of the included studies are provided in Table 1. <span id="r2_23">After removing reviews with duplicate exposure/outcome combinations, our process yielded 246 unique effect/outcome combinations contributed from 103 reviews.</span> These effects represent the findings of 2,496 primary studies comprised of 2,026,054 participants.
...
29\. Viechtbauer, W. *Metafor: Meta-analysis package for r*. (2022).

30\. R Core Team. *R: A language and environment for statistical computing*. (R Foundation for Statistical Computing, 2022).

31\. Egger, M., Smith, G. D., Schneider, M. & Minder, C. Bias in meta-analysis detected by a simple, graphical test. *BMJ* **315**, 629–634 (1997).

32\. Page, M. J., Higgins, J. P. & Sterne, J. A. Chapter 13: Assessing risk of bias due to missing results in a synthesis. in *Cochrane Handbook for Systematic Reviews of Interventions* (eds. Higgins, J. P. et al.) (Cochrane, 2021).

33\. Ioannidis, J. P. & Trikalinos, T. A. An exploratory test for an excess of significant findings. *Clinical Trials* **4**, 245–253 (2007).

34\. Papadimitriou, N. *et al.* An umbrella review of the evidence associating diet and cancer risk at 11 anatomical sites. *Nature Communications* **12**, 4579 (2021).

35\. Xie, H. *et al.* Can Touchscreen Devices be Used to Facilitate Young Children’s Learning? A Meta-Analysis of Touchscreen Learning Effect. *Frontiers in Psychology* **9**, 2580 (2018).

36\. Adelantado-Renau, M. *et al.* Association Between Screen Media Use and Academic Performance Among Children and Adolescents: A Systematic Review and Meta-analysis. *JAMA Pediatrics* **173**, 1058 (2019).

37\. Madigan, S., McArthur, B. A., Anhorn, C., Eirich, R. & Christakis, D. A. Associations Between Screen Use and Child Language Skills: A Systematic Review and Meta-analysis. *JAMA Pediatrics* **174**, 665 (2020).

38\. Poorolajal, J., Sahraei, F., Mohamdadi, Y., Doosti-Irani, A. & Moradi, L. Behavioral factors influencing childhood obesity: A systematic review and meta-analysis. *Obesity Research & Clinical Practice* **14**, 109–118 (2020).

39\. Byun, J. & Joung, E. Digital game-based learning for K-12 mathematics education: A meta-analysis. *School Science and Mathematics* **118**, 113–126 (2018).

40\. Vannucci, A., Simpson, E. G., Gagnon, S. & Ohannessian, C. M. Social media use and risky behaviors in adolescents: A meta-analysis. *Journal of Adolescence* **79**, 258–274 (2020).

41\. Yoon, S., Kleinman, M., Mertz, J. & Brannick, M. Is social network site usage related to depression? A meta-analysis of FacebookDepression relations. *Journal of Affective Disorders* **248**, 65–72 (2019).

42\. Vahedi, Z. & Zannella, L. The association between self-reported depressive symptoms and the use of social networking sites (SNS): A meta-analysis. *Current Psychology* **40**, 2174–2189 (2021).

43\. Seetharaman, G. W., Jeff Horwitz and Deepa. Facebook Knows Instagram Is Toxic for Teen Girls, Company Documents Show. *Wall Street Journal* (2021).

44\. Tekedere, H. & Göke, H. Examining the Effectiveness of Augmented Reality Applications in Education: A Meta-Analysis. *International Journal of Environmental and Science Education* **11**, 9469–9481 (2016).

45\. Sadeghirad, B., Duhaney, T., Motaghipisheh, S., Campbell, N. R. C. & Johnston, B. C. Influence of unhealthy food and beverage marketing on children’s dietary intake and preference: A systematic review and meta-analysis of randomized trials. *Obesity Reviews* **17**, 945–959 (2016).

46\. Marshall, S. J., Biddle, S. J. H., Gorely, T., Cameron, N. & Murdey, I. Relationships between media use, body fatness and physical activity in children and youth: A meta-analysis. *International Journal of Obesity* **28**, 1238–1246 (2004).

47\. Elson, M. *et al.* Do policy statements on media effects faithfully represent the science? *Advances in Methods and Practices in Psychological Science* **2**, 12–25 (2019).

48\. Ashton, J. J. & Beattie, R. M. Screen time in children and adolescents: Is there evidence to guide parents and policy? *The Lancet Child & Adolescent Health* **3**, 292–294 (2019).

49\. Royal College of Paediatrics and Child Health. *The health impacts of screen time: A guide for clinicians and parents.* (2019).

50\. Parry, D. A. *et al.* A systematic review and meta-analysis of discrepancies between logged and self-reported digital media use. *Nature Human Behaviour* **5**, 1535–1547 (2021).

51\. Byrne, R., Terranova, C. O. & Trost, S. G. Measurement of screen time among young children aged 0 years: A systematic review. *Obesity Reviews* **22**, (2021).

52\. Smith, C., Galland, B. C., de Bruin, W. E. & Taylor, R. W. Feasibility of automated cameras to measure screen use in adolescents. *American journal of preventive medicine* **57**, 417–424 (2019).

53\. Ryding, F. C. & Kuss, D. J. Passive objective measures in the assessment of problematic smartphone use: A systematic review. *Addictive Behaviors Reports* **11**, 100257 (2020).

54\. Guyatt, G. *et al.* GRADE guidelines: 1. IntroductionGRADE evidence profiles and summary of findings tables. *Journal of Clinical Epidemiology* **64**, 383–394 (2011).

55\. Twenge, J. M. More Time on Technology, Less Happiness? Associations Between Digital-Media Use and Psychological Well-Being. *Current Directions in Psychological Science* **28**, 372–379 (2019).

56\. Kelly, Y., Zilanawala, A., Booker, C. & Sacker, A. Social Media Use and Adolescent Mental Health: Findings From the UK Millennium Cohort Study. *EClinicalMedicine* **6**, 59–68 (2018).
