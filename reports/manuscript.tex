...
In this prospectively registered umbrella review (PROSPERO; CRD42017076051), we harmonised effects from 102 meta-analyses (2,451 primary studies; 1,937,501 participants) on screen time and any outcome for youths.
Some types of screen use, such as social media, were consistently correlated with risks (e.g., depression, \emph{r} = 0.12, 95\% confidence interval 0.05 to 0.19) while others, such as educational screen use, showed associations with benefits (e.g., motivation for learning, \emph{r} = 0.16, 95\% confidence interval 0.02 to 0.31).
Some types of screen use have complex associations with outcomes.
For example, television viewing showed harmful correlations with learning (\emph{r} = -0.10, 95\% confidence interval -0.15 to -0.04).
However, when parents watched with their children, general screen use was associated with greater literacy (\emph{r} = 0.15, 95\% confidence interval 0.02 to 0.28).
...
\leavevmode\vadjust pre{\hypertarget{ref-blairReadingStrategiesCoping2003}{}}%
\CSLLeftMargin{1. }
...
\leavevmode\vadjust pre{\hypertarget{ref-bell1883sanitarian}{}}%
\CSLLeftMargin{2. }
\CSLRightInline{Bell, A. N. \emph{The sanitarian}. vol. 11 ({AN Bell}, 1883).}

\leavevmode\vadjust pre{\hypertarget{ref-dill2013oxford}{}}%
\CSLLeftMargin{3. }
\CSLRightInline{Dill, K. E. \emph{The {Oxford} handbook of media psychology}. ({Oxford University Press}, 2013).}

\leavevmode\vadjust pre{\hypertarget{ref-wartellaChildrenComputersNew2000}{}}%
\CSLLeftMargin{4. }
...
\leavevmode\vadjust pre{\hypertarget{ref-sweetserActivePassiveScreen2012}{}}%
\CSLLeftMargin{8. }
...
\leavevmode\vadjust pre{\hypertarget{ref-liEarlyChildhoodComputer2004}{}}%
\CSLLeftMargin{9. }
...
\leavevmode\vadjust pre{\hypertarget{ref-warburton2017children}{}}%
\CSLLeftMargin{10. }
...
\leavevmode\vadjust pre{\hypertarget{ref-naturehumanbehaviourScreenTimeHow2019}{}}%
\CSLLeftMargin{11. }
\CSLRightInline{Nature Human Behaviour. Screen time: How much is too much? \emph{Nature} \textbf{565}, 265--266 (2019).}

\leavevmode\vadjust pre{\hypertarget{ref-whoGuidelinesPhysicalActivity2019}{}}%
\CSLLeftMargin{12. }
...
\leavevmode\vadjust pre{\hypertarget{ref-australiangovernmentPhysicalActivityExercise2021}{}}%
\CSLLeftMargin{13. }
\CSLRightInline{Australian Government. \emph{Physical activity and exercise guidelines for all {Australians}}. (2021).}

\leavevmode\vadjust pre{\hypertarget{ref-Canadian24HourMovement2016}{}}%
\CSLLeftMargin{14. }
...
\leavevmode\vadjust pre{\hypertarget{ref-AAPMediaUseSchoolAged2016}{}}%
\CSLLeftMargin{15. }
...
\leavevmode\vadjust pre{\hypertarget{ref-fergusonEverythingModerationModerate2017}{}}%
\CSLLeftMargin{16. }
...
\leavevmode\vadjust pre{\hypertarget{ref-sandersTypeScreenTime2019}{}}%
\CSLLeftMargin{18. }
...
\leavevmode\vadjust pre{\hypertarget{ref-kayeConceptualMethodologicalMayhem2020}{}}%
\CSLLeftMargin{19. }
...
\leavevmode\vadjust pre{\hypertarget{ref-chassiakosChildrenAdolescentsDigital2016}{}}%
\CSLLeftMargin{20. }
...
\leavevmode\vadjust pre{\hypertarget{ref-stiglicEffectsScreentimeHealth2019}{}}%
\CSLLeftMargin{21. }
...
\leavevmode\vadjust pre{\hypertarget{ref-valkenburgSocialMediaUse2022}{}}%
\CSLLeftMargin{22. }
...
\leavevmode\vadjust pre{\hypertarget{ref-arias-delatorreRelationshipDepressionUse2020}{}}%
\CSLLeftMargin{23. }
...
\leavevmode\vadjust pre{\hypertarget{ref-pollockChapterOverviewsReviews2022}{}}%
\CSLLeftMargin{25. }
...
\leavevmode\vadjust pre{\hypertarget{ref-xieCanTouchscreenDevices2018}{}}%
\CSLLeftMargin{26. }
...
\leavevmode\vadjust pre{\hypertarget{ref-adelantado-renauAssociationScreenMedia2019}{}}%
\CSLLeftMargin{27. }
...
\leavevmode\vadjust pre{\hypertarget{ref-madiganAssociationsScreenUse2020}{}}%
\CSLLeftMargin{28. }
...
\leavevmode\vadjust pre{\hypertarget{ref-poorolajalBehavioralFactorsInfluencing2020}{}}%
\CSLLeftMargin{29. }
...
\leavevmode\vadjust pre{\hypertarget{ref-byunDigitalGamebasedLearning2018}{}}%
\CSLLeftMargin{30. }
...
\leavevmode\vadjust pre{\hypertarget{ref-vannucciSocialMediaUse2020}{}}%
\CSLLeftMargin{31. }
...
\leavevmode\vadjust pre{\hypertarget{ref-yoonSocialNetworkSite2019}{}}%
\CSLLeftMargin{32. }
...
\leavevmode\vadjust pre{\hypertarget{ref-vahediAssociationSelfreportedDepressive2021}{}}%
\CSLLeftMargin{33. }
...
\leavevmode\vadjust pre{\hypertarget{ref-seetharamanFacebookKnowsInstagram2021}{}}%
\CSLLeftMargin{34. }
...
\leavevmode\vadjust pre{\hypertarget{ref-tekedereExaminingEffectivenessAugmented2016}{}}%
\CSLLeftMargin{35. }
...
\leavevmode\vadjust pre{\hypertarget{ref-sadeghiradInfluenceUnhealthyFood2016}{}}%
\CSLLeftMargin{36. }
...
\leavevmode\vadjust pre{\hypertarget{ref-marshallRelationshipsMediaUse2004}{}}%
\CSLLeftMargin{37. }
...
\leavevmode\vadjust pre{\hypertarget{ref-elsonPolicyStatementsMedia2019}{}}%
\CSLLeftMargin{38. }
...
\leavevmode\vadjust pre{\hypertarget{ref-ashtonScreenTimeChildren2019}{}}%
\CSLLeftMargin{39. }
...
\leavevmode\vadjust pre{\hypertarget{ref-royalcollegeofpaediatricsandchildhealthHealthImpactsScreen2019}{}}%
\CSLLeftMargin{40. }
...
\leavevmode\vadjust pre{\hypertarget{ref-markerExploringMythChubby2022}{}}%
\CSLLeftMargin{41. }
...
\leavevmode\vadjust pre{\hypertarget{ref-pagePRISMA2020Statement2020}{}}%
\CSLLeftMargin{42. }
...
\leavevmode\vadjust pre{\hypertarget{ref-parrySystematicReviewMetaanalysis2021}{}}%
\CSLLeftMargin{43. }
...
\leavevmode\vadjust pre{\hypertarget{ref-byrneMeasurementScreenTime2021}{}}%
\CSLLeftMargin{44. }
...
\leavevmode\vadjust pre{\hypertarget{ref-smithFeasibilityAutomatedCameras2019}{}}%
\CSLLeftMargin{45. }
...
\leavevmode\vadjust pre{\hypertarget{ref-rydingPassiveObjectiveMeasures2020}{}}%
\CSLLeftMargin{46. }
...
\leavevmode\vadjust pre{\hypertarget{ref-guyattGRADEGuidelinesIntroduction2011}{}}%
\CSLLeftMargin{47. }
...
\leavevmode\vadjust pre{\hypertarget{ref-twengeMoreTimeTechnology2019}{}}%
\CSLLeftMargin{48. }
...
\leavevmode\vadjust pre{\hypertarget{ref-kellySocialMediaUse2018}{}}%
\CSLLeftMargin{49. }
...
\leavevmode\vadjust pre{\hypertarget{ref-NHLBIQualityAssessmentSystematic2014}{}}%
\CSLLeftMargin{50. }
...
\leavevmode\vadjust pre{\hypertarget{ref-bowmanEffectSizesStatistical2012}{}}%
\CSLLeftMargin{51. }
...
\leavevmode\vadjust pre{\hypertarget{ref-jacobsEstimationBiserialCorrelation2017}{}}%
\CSLLeftMargin{52. }
...
\leavevmode\vadjust pre{\hypertarget{ref-pageChapter13Assessing2021}{}}%
\CSLLeftMargin{58. }
...
\leavevmode\vadjust pre{\hypertarget{ref-ioannidisExploratoryTestExcess2007}{}}%
\CSLLeftMargin{59. }
...
\leavevmode\vadjust pre{\hypertarget{ref-papadimitriouUmbrellaReviewEvidence2021}{}}%
\CSLLeftMargin{60. }
