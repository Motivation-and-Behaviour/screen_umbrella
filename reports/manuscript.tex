...
Of these, 43 effects from 32 met our criteria for statistical certainty.
Some types of screen use, such as social media, were consistently correlated with risks (e.g., depression, \emph{r} = 0.12, 95\% confidence interval {[}CI{]} 0.05 to 0.19, \emph{p} = \textless0.001, \emph{k} = 12, \emph{N} = 93,740) while others, such as educational screen use, showed associations with benefits (e.g., motivation for learning, \emph{r} = 0.16, 95\% CI 0.02 to 0.31, \emph{p} = 0.029, \emph{k} = 10, \emph{N} = 1,183).
Some types of screen use have complex associations with outcomes.
For example, television viewing showed harmful correlations with learning (\emph{r} = -0.10, 95\% CI -0.15 to -0.04, \emph{p} = \textless0.001, \emph{k} = 18, \emph{N} = 62,135).
However, when parents watched with their children, general screen use was associated with greater literacy (\emph{r} = 0.15, 95\% CI 0.02 to 0.28, \emph{p} = 0.028, \emph{k} = 12, \emph{N} = 6,083).
