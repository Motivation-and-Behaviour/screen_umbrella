...
We think synthesising the trade-offs in one review can help us understand when screen time might be associated with good/poor outcomes, helping to better understand why.
...
We appreciate it is not a direct contrast to compare overall limits of screen time against deleterious effects of screen time over 3-4 hours. As a result, we have removed the words 'in contrast':
...
We agree both guidelines focus on merely reducing recreational screen time and have removed "in all instances".
Even within recreational screen time, however, our findings do not support guidelines which focus just on minimisation. 
