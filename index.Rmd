...
After extracting data, we examined the combinations of exposure and outcomes and removed any effects that appeared more than once, keeping the effect with the largest total effect size. This process yielded `r nrow(effects_clean)` unique effects/outcome combinations contributed from `r prisma$data$value[9]` papers.
