...
```{r, fig.cap=paste("Forest Plot for ", plots[[1]]$name," Outcomes"), fig.width=12, fig.height=10}
plots[[1]]$plot
```

### `r plots[[2]]$name`

```{r, fig.cap=paste("Forest Plot for ", plots[[2]]$name," Outcomes"), fig.width=12, fig.height=10}
plots[[2]]$plot
```

### `r plots[[3]]$name`

```{r, fig.cap=paste("Forest Plot for ", plots[[3]]$name," Outcomes"), fig.width=12, fig.height=10}
plots[[3]]$plot
```

### `r plots[[4]]$name`

```{r, fig.cap=paste("Forest Plot for ", plots[[4]]$name," Outcomes"), fig.width=12, fig.height=10}
plots[[4]]$plot
```
...
```{r, fig.cap="Forest Plot for Health Behaviour Outcomes", fig.width=12, fig.height=15}
comparison_plots$`health behaviour`
```

### Physical Health

```{r, fig.cap="Forest Plot for Physical Health Outcomes", fig.width=12, fig.height=15}
comparison_plots$`physical health`
```

### Psychology

```{r, fig.cap="Forest Plot for Psychology Outcomes", fig.width=12, fig.height=15}
comparison_plots$psychology
```

### Education

```{r, fig.cap="Forest Plot for Education Outcomes", fig.width=12, fig.height=15}
